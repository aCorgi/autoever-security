...
class RepositoryContainerExtension : BeforeAllCallback {
    companion object {
        private const val KAFKA_DOCKER_IMAGE = "confluentinc/cp-kafka:7.5.1"
        private const val RABBITMQ_DOCKER_IMAGE = "rabbitmq:3.12-management"

        // The default Kafka port is 9092, but testcontainers kafka uses port 9093
        const val KAFKA_PORT = 9093
